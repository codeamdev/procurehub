...
import {
  ...
  ChevronsRight, ChevronLeft, ChevronRight, Filter, Pencil
} from 'lucide-react'
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="border-b border-slate-100 dark:border-slate-800">
                  ...
                  {/* Actions */}
                  <th className="px-3 py-2 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-800/50 w-16" />
                </tr>
              </thead>
              <tbody>
                {paginated.length === 0 ? (
                  <tr>
                    <td colSpan={workflowId ? 5 : 6} className="text-center py-16 text-slate-400 dark:text-slate-500 text-sm">
                      {all.length === 0
                      ...
                      >
                        <td className={tdClass}>
                          <div className="font-semibold text-slate-800 dark:text-white">
                            {req.code && (
                              <span className="mr-2 text-xs font-mono text-slate-400 dark:text-slate-500">
                                {req.code}
                              </span>
                            )}
                        ...
                        <td className={`${tdClass} text-center`}>
                          <button
                            ...
                            className="inline-flex items-center justify-center w-8 h-8 rounded-lg text-slate-400 hover:text-violet-600 dark:hover:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-900/20 transition-colors"
